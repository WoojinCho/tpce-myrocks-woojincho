...
CREATE TABLE account_permission (
  ...
  PRIMARY KEY (ap_ca_id, ap_tax_id) comment 'accountpermission'
...
CREATE TABLE customer (
  ...
  PRIMARY KEY (c_id) comment 'customer'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE customer_account (
  ...
  PRIMARY KEY (ca_id) comment 'customeraccount'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE customer_taxrate (
  ...
  PRIMARY KEY (cx_c_id, cx_tx_id) comment 'customertaxrate'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE holding (
  ...
  PRIMARY KEY (h_t_id) comment 'holding'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE holding_history (
  ...
  PRIMARY KEY (hh_t_id, hh_h_t_id) comment 'holdinghistory'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE holding_summary (
  ...
  PRIMARY KEY (hs_ca_id, hs_s_symb) comment 'holdingsummary'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE watch_item (
  ...
  PRIMARY KEY (wi_wl_id, wi_s_symb) comment 'watchitem'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE watch_list (
  ...
  PRIMARY KEY (wl_id) comment 'watchlist'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE broker (
  ...
  PRIMARY KEY (b_id) comment 'broker'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE cash_transaction (
  ...
  ct_name VARCHAR(100),
  PRIMARY KEY (ct_t_id) comment 'cashtransaction'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE charge (
  ...
  PRIMARY KEY (ch_tt_id, ch_c_tier) comment 'charge'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE commission_rate (
  ...
  PRIMARY KEY (cr_c_tier, cr_tt_id, cr_ex_id, cr_from_qty) comment 'commissionrate'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE settlement (
  ...
  PRIMARY KEY (se_t_id) comment 'settlement'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE trade (
  ...
  PRIMARY KEY (t_id) comment 'trade'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE trade_history (
  ...
  PRIMARY KEY (th_t_id, th_st_id) comment 'tradehistory'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE trade_request (
  ...
  PRIMARY KEY (tr_t_id) comment 'traderequest'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE trade_type (
  ...
  PRIMARY KEY (tt_id) comment 'tracetype'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE company (
  ...
  PRIMARY KEY (co_id) comment 'company'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE company_competitor (
  ...
  PRIMARY KEY (cp_co_id, cp_comp_co_id, cp_in_id) comment 'companycompetitor'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE daily_market (
  ...
  PRIMARY KEY (dm_s_symb, dm_date) comment 'dailymarket'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE exchange (
  ...
  PRIMARY KEY (ex_id) comment 'exchange'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE financial (
  ...
  PRIMARY KEY (fi_co_id, fi_year, fi_qtr) comment 'financial'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE industry (
  ...
  PRIMARY KEY (in_id) comment 'industry'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE last_trade (
  ...
  PRIMARY KEY (lt_s_symb) comment 'lasttrade'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE news_item (
  ...
  PRIMARY KEY (ni_id) comment 'newsitem'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE news_xref (
  ...
  PRIMARY KEY (nx_co_id, nx_ni_id) comment 'newsxref'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE sector (
  ...
  PRIMARY KEY (sc_id) comment 'sector'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE security (
  ...
  PRIMARY KEY (s_symb) comment 'security'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE address (
  ...
  ad_ctry VARCHAR(80),
  PRIMARY KEY (ad_id) comment 'address'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE status_type (
  ...
  PRIMARY KEY (st_id) comment 'status_type'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE taxrate (
  ...
  PRIMARY KEY (tx_id) comment 'taxrate'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
...
CREATE TABLE zip_code (
  ...
  PRIMARY KEY (zc_code) comment 'zipcode'
) ENGINE=RocksDB DEFAULT COLLATE=latin1_bin;
